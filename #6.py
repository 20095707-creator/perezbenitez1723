...
# ═══════════════════════════════════════════════════════════════
#  VENTANA DE CAPTURA DE ROSTRO (mejorada, sin conflictos)
# ═══════════════════════════════════════════════════════════════
    ...
    def _capturar(self):
        ...
        if frame is not None:
            ...
            if encs:
                ...
                messagebox.showinfo("Capturado", "Rostro capturado correctamente.")
...
# ═══════════════════════════════════════════════════════════════
#  PANTALLA 6 – GESTIÓN DE ESTUDIANTES (captura simplificada)
# ═══════════════════════════════════════════════════════════════
...
class FormEstudiante(BaseWindow):
    def __init__(self, master, est_id, callback):
        ...
        self.est_id   = est_id
        self.callback = callback
        self.face_encoding = None   # codificación capturada (aún no guardada en BD)
        self._build()
    ...
    def _build(self):
        ...
        # Un solo botón para capturar rostro (se convierte en ✅ al capturar)
    ...
    def _guardar(self):
        ...
        # Guardar codificación facial si se capturó una nueva
